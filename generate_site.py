...
RESTRICTED_BANNER = """<div class="banner danger">
  ...
  מסמך המקור מוגדר על ידי אינטרפול כחומר רגיש למטרות אכיפת חוק בלבד, ואינו מיועד להפצה פומבית ללא אישור בכתב מאינטרפול. אתר זה אינו מקודם ואינו מוצג בתוצאות חיפוש — הקישור אליו מיועד לחברי החטיבה בלבד, ואין להפיץ אותו הלאה מחוץ לארגון.
</div>
"""
